...
// VEHICLE FUNCTIONS
	...
	void Vehicle::init( OgreNewt::Body* chassis, Ogre::Vector3 updir )
	{
	...
	// get first tire.
	OgreNewt::Vehicle::Tire* Vehicle::getFirstTire()
	{
	...
	// get next tire.
	OgreNewt::Vehicle::Tire* Vehicle::getNextTire( Vehicle::Tire* current_tire )
	{
		Vehicle::Tire* tire = NULL;
		int id = 0;

		id = NewtonVehicleGetNextTireID( m_vehicle, current_tire->getNewtonID() );
