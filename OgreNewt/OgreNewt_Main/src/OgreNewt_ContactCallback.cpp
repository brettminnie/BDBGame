...
Ogre::Vector3 ContactCallback::getContactForce()
{
	Ogre::Vector3 force;
...
void ContactCallback::getContactPositionAndNormal( Ogre::Vector3& pos, Ogre::Vector3& norm )
{
	NewtonMaterialGetContactPositionAndNormal( m_material, &pos.x, &norm.x );
}


void ContactCallback::getContactTangentDirections( Ogre::Vector3& dir0, Ogre::Vector3& dir1 )
{
