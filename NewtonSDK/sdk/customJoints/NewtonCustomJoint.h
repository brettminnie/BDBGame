...
class NewtonCustomJoint  
{
	...
	// tha application need to implement thos funtion for each derived joint. See examples for more detail
	...
	private:
	// this are the callback needed to have transpartent c++ method interfaces 
